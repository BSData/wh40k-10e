...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-352e-adc2-7639-d6a9" name="Warhammer 40,000 10th Edition" revision="62" battleScribeVersion="2.03" type="gameSystem">
  <publications>
      ...
      <selectionEntries>
        ...
        <selectionEntry type="upgrade" import="true" name="Heirloom (A+1)" hidden="false" id="2801-9f1c-645d-cb3d">
          ...
          <modifiers>
            <modifier type="set" value="true" field="hidden">
              <conditions>
                <condition type="instanceOf" value="1" field="selections" scope="parent" childId="84c4-6d1e-e724-bd6e" shared="true"/>
              </conditions>
            </modifier>
          </modifiers>
        </selectionEntry>
